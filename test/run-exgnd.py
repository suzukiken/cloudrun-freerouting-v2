...
DSN_FILE = "intermediate-exgnd.dsn"
SESSION_FILE = "intermediate-exgnd.ses"
...
def main():
    ...
    route_request = urllib.request.Request(
        url=FREEROUTING_CLOUDRUN_URL + "/getroutebottomexceptgnd/", data=dsn_data.encode(), method="POST"
    )
